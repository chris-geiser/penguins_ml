...
# Dataset import and apply previously trained model
...
# Make prediction based on inputs and model
...
# Explain prediction through charts and data
st.write(
